  ...
  return (
    <footer className="relative border-t border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950/80 text-slate-600 dark:text-slate-400 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 pb-safe">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-300 dark:border-slate-800/80 flex flex-col md:flex-row items-center justify-between text-xs gap-4 text-center md:text-left text-slate-600 dark:text-slate-400 font-medium">
          <p className="break-words">© {new Date().getFullYear()} 15 Product Prompts. All rights reserved. 100% Client-Side SaaS Architecture.</p>
          <div className="flex items-center justify-center gap-1 text-slate-600 dark:text-slate-400 font-medium shrink-0">
